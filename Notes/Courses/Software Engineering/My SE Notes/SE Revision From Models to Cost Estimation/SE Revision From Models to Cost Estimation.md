...
![Incremental Development Process](se_revision_assets/lec02_incremental_process.png)
...
![Prototyping Model](se_revision_assets/lec02_prototyping_model.png)
...
![Spiral Model](se_revision_assets/lec02_spiral_model.png)
...
![RUP Diagram](se_revision_assets/lec02_rup_diagram.png)
...
![Imprecise Requirements](se_revision_assets/lec03_imprecise_requirements.png)
...
![Ambiguous Incomplete Inconsistent Example](se_revision_assets/lec03_ambiguous_incomplete_inconsistent.png)
...
![Structured Natural Language Specification](se_revision_assets/lec03_structured_natural_language.png)
...
![ATM Graphical Specification](se_revision_assets/lec03_graphical_spec_atm.png)

适合描述状态变化、流程、条件。

### Tabular Specification

![ATM Tabular Specification](se_revision_assets/lec03_tabular_spec_atm.png)
...
![DFD Insulin Example](se_revision_assets/lec12_dataflow_insulin.png)
...
![Activity Parallel Register](se_revision_assets/activity_parallel_register.png)
...
![Activity Selection Borrow Renew](se_revision_assets/activity_selection_borrow_renew.png)
...
![Pattern](se_revision_assets/lec08_pattern.png)
...
![Modularity](se_revision_assets/lec08_modularity.png)
...
![Information Hiding](se_revision_assets/lec08_information_hiding.png)
...
![Independence](se_revision_assets/lec08_independence.png)
...
![Cohesion](se_revision_assets/lec08_cohesion.png)
...
![Coupling](se_revision_assets/lec08_coupling.png)
...
![Architectural Design Questions](se_revision_assets/lec08_arch_design_questions.png)
...
![Architecture Perspectives](se_revision_assets/lec08_arch_perspectives.png)
...
![System Organization Models](se_revision_assets/lec09_system_org_models.png)
...
![Repository Model](se_revision_assets/lec09_repository_model.png)
...
![Client-Server Model](se_revision_assets/lec09_client_server_model.png)
...
![Peer-to-Peer Model](se_revision_assets/lec09_peer_to_peer_model.png)
...
![Layered Three Tier](se_revision_assets/lec09_layered_three_tier.png)
...
![MVC Model](se_revision_assets/lec09_mvc_model_diagram.png)
...
![UML MVC Model](se_revision_assets/lec09_uml_mvc_model.png)
...
![MVC Problem](se_revision_assets/lec09_mvc_problem.png)
...
![Observer Application](se_revision_assets/lec09_observer_application.png)
...
![OO vs Structured](se_revision_assets/oo_vs_structured_user_screenshot.png)
...
![Observer Structure](se_revision_assets/lec09_observer_structure.png)
...
![Pre/Post VerifyCities](se_revision_assets/lec11_pre_post_verifyCities.png)
...
![Lecture 12 OO vs Structured](se_revision_assets/lec12_oo_vs_structured.png)
...
![Architecture Design Steps](se_revision_assets/lec12_arch_design_steps.png)
...
![Isolating Transform Center](se_revision_assets/lec12_isolate_transform_center.png)
...
![First Level Factoring](se_revision_assets/lec12_first_level_factoring.png)
...
![Example 1 Tree](se_revision_assets/lec12_example1_tree.png)
...
![Example 2 Tree](se_revision_assets/lec12_example2_tree.png)
...
![E-ticketing Transform Center](se_revision_assets/lec12_eticket_transform_center.png)

### First-level factoring

![E-ticketing First Level](se_revision_assets/lec12_eticket_first_level.png)
...
![E-ticketing Second Level](se_revision_assets/lec12_eticket_second_level.png)
...
![Move Credit Card Info](se_revision_assets/lec12_move_credit_card_info.png)
...
![Add Save Info](se_revision_assets/lec12_add_save_info.png)
...
![SDLC Testing](se_revision_assets/lec13_sdlc_testing.png)
...
![Equivalence Class](se_revision_assets/lec13_equivalence_class.png)
...
![Boundary Value](se_revision_assets/lec13_boundary_value.png)
...
![Control Flow Graph](se_revision_assets/lec13_control_flow_graph.png)
...
![Branch Testing](se_revision_assets/lec13_branch_testing.png)

每个 decision 的每个 branch 至少执行一次。

### Path Testing

![Path Testing](se_revision_assets/lec13_path_testing.png)
...
![Test Oracle](se_revision_assets/lec14_test_oracle.png)
...
![Test Process](se_revision_assets/lec14_test_process.png)
...
![Test Automation](se_revision_assets/lec14_test_automation.png)
...
![State Diagram Test Cases](se_revision_assets/lec14_state_diagram_test_cases.png)
...
![Whitebox Condition](se_revision_assets/lec14_whitebox_condition.png)
...
![Test Case Management](se_revision_assets/lec14_test_case_management.png)
...
![Test Driver](se_revision_assets/lec14_test_driver.png)
...
![Generate Oracles](se_revision_assets/lec14_generate_oracles.png)

Oracle 可以从 specification 生成，但只有 specification 是 defined notation 时才容易自动生成。

![Compare Results](se_revision_assets/lec14_compare_results.png)
...
![CM Planning](se_revision_assets/lec15_cm_planning.png)
...
![Change Management Process](se_revision_assets/lec15_change_management_process.png)
...
![Version Control](se_revision_assets/lec15_version_control.png)
...
![Release Strategy](se_revision_assets/lec15_release_strategy.png)
...
![System Building](se_revision_assets/lec15_system_building.png)
...
![Executable Versions](se_revision_assets/lec15_executable_versions.png)
...
![Git Tool](se_revision_assets/lec15_git_tool.png)
...
![Person Month](se_revision_assets/lec16_person_month.png)
...
![Size Metrics](se_revision_assets/lec16_size_metrics.png)
...
![Function Points](se_revision_assets/lec16_function_points.png)
...
![Object Points](se_revision_assets/lec16_object_points.png)
...
![Algorithmic Model](se_revision_assets/lec16_algorithmic_model.png)
...
![Application Composition Formula](se_revision_assets/lec16_application_composition_formula.png)
...
![Exponent B](se_revision_assets/lec16_exponent_B.png)
...
![Reuse Model 1](se_revision_assets/lec16_reuse_model1.png)
...
![Reuse Model 2](se_revision_assets/lec16_reuse_model2.png)
...
![Post Architecture Size](se_revision_assets/lec16_post_architecture_size.png)
...
![Post Architecture Example](se_revision_assets/lec16_post_arch_example.png)
...
![TDEV Staffing](se_revision_assets/lec16_tdev_staffing.png)

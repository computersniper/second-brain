...
- For detailed rules, see [10 Include vs Extend](./10%20Include%20vs%20Extend.md).
- For the full relationship table, see [11 Use Case Diagram Relationships](./11%20Use%20Case%20Diagram%20Relationships.md).
